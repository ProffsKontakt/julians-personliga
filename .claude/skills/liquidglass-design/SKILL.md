---
name: liquidglass-design
description: Apple iOS 26 Liquid Glass design language implemented with native Tailwind CSS utility classes from the liquidglass-tailwind plugin (glass-card, glass-btn, glass-nav, glass-modal, glass-surface, glass-shine). Use when building or restyling glassmorphic web UI with Tailwind - frosted cards, translucent navbars, sheets, segmented controls - and when the user mentions "liquid glass", "glass design", "iOS 26 style" or "glassmorphism". Covers opacity hierarchy, dark mode adaptation, accessibility fallbacks and performance limits on backdrop-filter.
---
