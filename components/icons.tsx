...
export const IconHome = ({ className, style }: P) => (
...
export const IconReceipt = ({ className, style }: P) => (
  <svg {...base(className, style)}>
...
export const IconChart = ({ className, style }: P) => (
  <svg {...base(className, style)}>
    <path d="M3.5 20.5h17" />
...
export const IconDumbbell = ({ className, style }: P) => (
  <svg {...base(className, style)}>
...
export const IconCamera = ({ className, style }: P) => (
  <svg {...base(className, style)}>
...
export const IconSparkle = ({ className, style }: P) => (
  <svg {...base(className, style)}>
...
export const IconWarning = ({ className, style }: P) => (
  <svg {...base(className, style)}>
...
export const IconArrowUp = ({ className, style }: P) => (
  <svg {...base(className, style)}>
    <path d="M12 19V6M6.5 11.5 12 6l5.5 5.5" />
  </svg>
);

export const IconArrowDown = ({ className, style }: P) => (
  <svg {...base(className, style)}>
...
export const IconBriefcase = ({ className, style }: P) => (
  <svg {...base(className, style)}>
    <path d="M3.75 8.75h16.5a.5.5 0 0 1 .5.5v9.5a1.5 1.5 0 0 1-1.5 1.5H4.75a1.5 1.5 0 0 1-1.5-1.5v-9.5a.5.5 0 0 1 .5-.5Z" />
    <path d="M9 8.75v-2a1.5 1.5 0 0 1 1.5-1.5h3a1.5 1.5 0 0 1 1.5 1.5v2" />
    <path d="M3.5 13.5c2.8 1 5.6 1.5 8.5 1.5s5.7-.5 8.5-1.5" />
  </svg>
);

/** Hexagon — motivet som går igenom hela Tron. Används som tom-tillstånd. */
export const IconHex = ({ className, style }: P) => (
  <svg {...base(className, style)}>
    <path d="M12 2.5 20.5 7.5v9L12 21.5 3.5 16.5v-9L12 2.5Z" />
  </svg>
);
